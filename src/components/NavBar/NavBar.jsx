...
const NavBar = () => {
    ...
    return(
        <div className={style.bigNav}>
            <div className={`${style.leftNav} ${ visible ? style.leftNavVisible : style.leftNavInvisible}`}>
                <button className={style.redesNav}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" className={`bi bi-instagram ${style.redesNav}`} viewBox="0 0 16 16">
