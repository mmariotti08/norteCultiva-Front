...
const Home = () => {
    ...
    return (
        <div className={style.container}>
            <img src="/IMG_3731.JPG" className={style.background}></img>
            ...
            <div className={style.Tienda}>
                ...
                <Link to="/LandingTienda">
                    <button className={style.Boton}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="180" height="180" fill="currentColor" className="bi bi-arrow-left-circle-fill" viewBox="0 0 16 16">
